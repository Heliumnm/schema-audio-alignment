...
\begin{figure*}[t]
  ...
  Standard, matched, and matched-long.}
  \label{fig:paired}
\end{figure*}
...
should use untouched cohorts with sufficient covariate overlap, additional backbones and
readouts, and separate audible evidence from independent clinical context.
